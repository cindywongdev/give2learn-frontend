...
{/* top container div */}  <div className='bg-blue-200 p-10'>
						...
						<Image className='mb-10' src={image1} alt=''width='20'></Image>
						<Image className='mb-10' src={image2} alt=''width='50'></Image>
		...
		{/*  */}
							...
							<div className=' bg-blue-200 p-10 justify-between flex'>
								<div className='justify-between flex'>
