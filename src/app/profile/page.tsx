		...
		<div className='p-5'>
			...
			<div className='bg-blue-200 p-10'>
				...
				<div className='flex justify-between'>
					<div className='flex'>
						<h1 className='px-5 py-8 py-4 bg-white mr-8 font-medium'>
							laptop
						</h1>
						<ul>
							<li>model</li>
					...
					<div>
						...
						<button
							className='  mt-7 py-2 px-5 bg-blue-500 rounded-lg mr-3 '
							type='button'>
							Edit
						</button>
						<button
							className='  mt-7 py-2 px-5 bg-blue-500 rounded-lg'
							type='button'>
							Cancel Request
						</button>
					</div>
