		...
		<header>
			<div className='flex items-center justify-between flex-wrap py-8 px-20 w-screen bg-g2l-pale-yellow drop-shadow-md'>
				...
				<div className='relative flex gap-12 items-center'>
					...
					<div onClick={() => setOpenProfileMenu(!openProfileMenu)} className='font-bold bg-g2l-bright-yellow px-3 py-2 rounded-full hover:cursor-pointer'>
						M
					</div>
					<div className={`absolute flex flex-col gap-2 bg-g2l-pale-yellow rounded-lg right-0 top-12 p-4 drop-shadow-lg ${openProfileMenu ? '' : 'hidden'}`}>
						<Link href='/user'>
							My profile
						</Link>
						<Link href='/profile'>
